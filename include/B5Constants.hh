...
constexpr G4int kNofHodoscopes1 = 2;
constexpr G4int kNofHodoscopes2 = 2;
constexpr G4int kNofChambers = 2;
constexpr G4int kNofEmColumns = 2;
constexpr G4int kNofEmRows = 2;
constexpr G4int kNofEmCells = kNofEmColumns * kNofEmRows;
constexpr G4int kNofHadColumns = 2;
